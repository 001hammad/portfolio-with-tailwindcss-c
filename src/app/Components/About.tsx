...
const About = () => {
  ...
  return (
   ...
   // ------------------FIRST WE USED A LARGE IMAGE OF PROGRAMMING--------------- 
     
    <div className="max-w-7xl mx-auto p-4 md:p-6 " id="About">
      <Image src={aboutpic} alt="About-Pic" width={850} data-aos="flip-left"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="2000" className="rounded-2xl sm:mt-0 mt-11 shadow-red-500 shadow-2xl sm:ml-32"/>
      <div className=" text-center p-4   lg:p-8">

      {/* // -------------------------OUR INTRO SECTION-----------------------  */}


        <h2 className="text-white font-bold text-4xl sm:mt-5 mt-10  md:text-3xl lg:text-4xl mb-4"data-aos="fade-down"
     data-aos-easing="linear"
     data-aos-duration="1000">
          My Introduction
        </h2>
        <p className="text-white text-xs md:text-lg  leading-relaxed"data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine"data-aos-duration="1000">
        ...
        <p className="text-white text-xs md:text-lg leading-relaxed"data-aos="fade-left"
     ...
     data-aos-duration="1000">
        ...
        <p className="text-white text-xs md:text-lg leading-relaxed sm:mb-28"data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine"data-aos-duration="1000">
